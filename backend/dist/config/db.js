...
const connectDB = async ()=> {
  try {
    ...
    const conn = await mongoose.connect(env.mongodbUri, {
      maxPoolSize: env.nodeEnv === 'production' ? 50,
      minPoolSize: env.nodeEnv === 'production' ? 10,
      maxIdleTimeMS, // Close idle connections after 30s
      socketTimeoutMS,
      serverSelectionTimeoutMS,
      heartbeatFrequencyMS, // Check replica set health every 10s
      retryWrites,
      retryReads,
      compressors, // Compress wire protocol messages
